...
public enum Tier {
	NONE("&f", "Custom", "Custom", "Custom Sword", "Custom Axe",
			"Custom Bow", "Custom Staff", "Custom Polearm"),
	TIER_1("&f", "Leather", "Wood", "Shortsword", "Hatchet",
	...
	TIER_2("&a", "Chainmail", "Stone", "Longsword", "Great Axe",
	...
	TIER_3("&b", "Magic", "Iron", "Magic Sword", "Magic Axe",
	...
	TIER_4("&d", "Ancient", "Diamond", "Ancient Sword", "Ancient Axe",
	...
	TIER_5("&e", "Legendary", "Gold", "Legendary Sword", "Legendary Axe",
