...
public abstract class AegeusItem {
	...
	public AegeusItem(Material material) { this.item = new ItemStack(material); }
	public AegeusItem(ItemStack item) { this.item = item; }
	...
	public void setMaterial(Material material) { item.setType(material); }
